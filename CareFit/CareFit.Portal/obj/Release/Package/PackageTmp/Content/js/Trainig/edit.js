$(document).ready(function () {
    SearchField("trainning-exercise-search", EditTrainningExercise, "/Exercise/GetTypeAheadAjax");
    InitSliderFields();
    SetDefaultSeries(false);
    InitColpick();

    $("#default-trainning-customer").selectpicker();
    ...
    $("#trainning-people-back").click(function () {
        $('#trainning-color').colpickHide();
        OpenContent("Training", "Peoples", null)
    });
...
function SaveTrainning() {
    ...
    var jsonDefaultTrainning = GetDefaultTrainnings();    
    var data = {
        jsonDefaultTrainning: JSON.stringify(jsonDefaultTrainning),
    ...
    var delegate = function (result) {
        ...
        if (peopleId > 0) {
            ...
            OpenContent("Training", "GetDefaultTrainnings", null);
        }
...
function GetDefaultTrainnings() {
    var defaultTrainnings = {
        Customers: $("#default-trainning-customer").val(),
        Professor: $("#default-trainning-people").is(":checked")
    }
